...
namespace VikingSimulator
{
    ...
    class Sprite
    {
        ...
        bool useLeftTexture = false;
        Texture2D currentTexture;
        int textureTimer = 10000;
        ...
        public void Move(dir direction)
        {
            ...
            if (direction == dir.East) { useLeftTexture = false; }
            else { useLeftTexture = true; }
        }
        ...
        public void Draw(SpriteBatch spriteBatch, SpriteFont damageFont)
        {
            if (textureTimer++ > 25)
            {
                if (useLeftTexture) { currentTexture = textureLeft; }
        ...
        public void reTextureLeft(Texture2D newTexture)
        {
            textureLeft = newTexture;
        }
